      ...
      <Container>
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            At ACOB Lighting, we are more than just an energy company; we are
            pioneers in sustainable development, dedicated to illuminating lives
            across Nigeria with innovative solar solutions.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {aboutSections.map((section, index) => (
            <Link key={section.href} href={section.href}>
              <Card className="overflow-hidden border-0 custom-shadow shadow-none p-0 hover:shadow-lg transition-shadow duration-300 h-full flex flex-col bg-surface">
