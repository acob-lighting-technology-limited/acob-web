      ...
      <Container>
        ...
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
            <MaskText phrases={['Pioneering Nigeria\'s Energy Access Revolution']} />
          </h2>
          <p className="text-lg text-muted-foreground max-w-4xl mx-auto leading-relaxed">
            The story of Nigeria's expansion of energy access to rural communities cannot be told without including the pioneering role played by ACOB Lighting Technology Limited. We have remained resilient in creating new pathways for growing and scaling solar mini-grid solutions, providing energy access to areas where grid extension projects cannot easily reach.
          </p>
        </div>
            ...
            <div className="bg-muted/30 p-8 rounded-lg">
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-muted-foreground">Deployed projects in 9 communities</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-3 h-3 bg-primary rounded-full"></div>
                  <span className="text-muted-foreground">Built 690 kWp combined system size</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-3 h-3 bg-primary rounded-full"></div>
                  <span className="text-muted-foreground">Powers 2,306 connections</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-3 h-3 bg-primary rounded-full"></div>
                  <span className="text-muted-foreground">19 communities under construction (90% completion)</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-3 h-3 bg-primary rounded-full"></div>
                  <span className="text-muted-foreground">2.74 MWp additional capacity in pipeline</span>
                </div>
              </div>
            </div>
          </div>
