...
import { getProjects, getFeaturedProjects, getUpdatePosts } from '@/sanity/lib/client';
...
export const metadata: Metadata = {
  ...
  keywords: 'solar energy, mini-grid solutions, street lighting, solar materials, renewable energy, Nigeria, ACOB Lighting, sustainable energy, clean power, solar installation',
