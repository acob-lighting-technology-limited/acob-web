        ...
        <FadeIn delay={0.2}>
          <div className="mb-8 sm:mb-12 md:mb-16">
            <div className="text-center sm:text-left">
              <Badge className="bg-primary/10 text-primary mb-4 sm:mb-6">
                Trusted partners
              </Badge>
              <MaskText
                phrases={[
              ...
              <div className="flex flex-col lg:flex-row lg:items-center gap-4 sm:gap-6">
                <div className="flex-1 space-y-2 sm:space-y-3">
                  ...
                  <p className="text-xs sm:text-sm md:text-base text-primary/80 leading-relaxed">
                    Read through case studies, metrics, and deployment models
                    tailored for utilities, municipalities, and enterprise
                    estates.
                  </p>
                </div>
