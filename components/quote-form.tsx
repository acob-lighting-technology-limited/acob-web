              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                {quoteFormFields
                  ...
                  .map(({ id, label, type, options, placeholder }) => (
                    <div key={id}>
                      <Label htmlFor={id} className="text-foreground pb-1">
                        {label} *
                      </Label>
                      {type === 'select' ? (
                        <select
                          ...
                          className="w-full px-3 py-2 border border-border rounded-md focus-visible:!ring-[1px] bg-surface text-foreground/60 text-xs ring-[0.5px] ring-border focus:outline-none focus:ring-2 focus:ring-primary"
                        >
                          {options?.map(option => (
