...
// Custom hook to format text with WhatsApp-like formatting
    ...
    <>
      ...
      >
        <Sheet open={isOpen} onOpenChange={setIsOpen}>
          ...
          <SheetContent
            side="right"
            className="w-full sm:w-[380px] h-[calc(100vh-4rem)] mt-16 sm:h-[80vh] fixed bottom-4 right-4 rounded-lg overflow-hidden shadow-2xl bg-[#e5e7eb] flex flex-col p-0"
            onInteractOutside={(e) => {
              e.preventDefault();
            }}
